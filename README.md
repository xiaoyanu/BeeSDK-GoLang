...
完整 API 分类、操作码和参数说明见 [API参考.md](./API参考.md)。
...
缓存的上下文不能作为通用全局 `bee`，也不能用于被动回复或事件响应。具体规则见 [AI开发指南.md](./AI开发指南.md#机器人上下文)。
...
| [API参考.md](./API参考.md) | 插件开发者 | 操作码、Go 方法、参数和辅助函数 |
| [AI开发指南.md](./AI开发指南.md) | AI 编程助手 | ABI、上下文、编码、内存和修改约束 |
...
- 修复或新增框架 API 后，同步更新 `API参考.md` 和 `AI开发指南.md`。
...
如果你准备使用 AI 辅助开发，请先让它完整阅读 [AI开发指南.md](./AI开发指南.md)。
